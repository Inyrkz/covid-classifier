...
def get_model():
    ...
    model2 = load_model("model_0.938.h5")
    model = load_model("covidmodel_0.989.h5")
    # model = load_model("/content/drive/MyDrive/PneumoniaX-master/covid_0.989.h5")
    # Model to detect Covid
    # model2 = load_model("/content/drive/MyDrive/PneumoniaX-master/model_0.938.h5")
    print(" * Models loaded!")
...
def pneumo():
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            prediction = model2.predict_proba(preprocessed_image, verbose=0).tolist()
